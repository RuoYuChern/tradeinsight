...
CREATE UNIQUE INDEX qt_sbd_uidx ON quant_trading(symbol,buy_date);
CREATE INDEX qt_bd_idx ON quant_trading(buy_date);

CREATE UNIQUE INDEX qf_sbd_uidx ON quant_find(symbol,trade_date);
CREATE INDEX qf_td_idx ON quant_find(trade_date);
